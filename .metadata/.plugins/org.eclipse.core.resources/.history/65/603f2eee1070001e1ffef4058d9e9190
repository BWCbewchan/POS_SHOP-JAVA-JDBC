	...
	private void initialize() {
		...
		groupLayout.setVerticalGroup(
			groupLayout.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(groupLayout.createSequentialGroup()
					.addComponent(qlbh_1, GroupLayout.DEFAULT_SIZE, 680, Short.MAX_VALUE)
					.addContainerGap())
		);
		...
		lblNewLabel.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/information-employee.png")));
		...
		iconSanPham.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/box.png")));
		...
		iconSanPham_1.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/bill.png")));
		...
		iconSanPham_1_1.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/sale2.png")));
		...
		iconNhanVien.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/emlpyee.png")));
		...
		iconKhachHang.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/customer.png")));
		...
		iconThongKe.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/statistical.png")));
		...
		iconDangXuat.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/logout3.png")));
		...
		lblIconBanHang.setIcon(new ImageIcon(uiChinh.class.getResource("/icon/buy.png")));
